...
export declare type ActionType<T> = T extends ActionTypes.CaptureCard ? ICaptureCard : T extends ActionTypes.StepUp ? IStepUp : T extends ActionTypes.UpdateCard ? IUpdateCard : T extends ActionTypes.ValidateCard ? IValidateCard : T extends ActionTypes.ValidatePayment ? IValidatePayment : IAction;
